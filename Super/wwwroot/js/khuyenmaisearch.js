            ...
            $.ajax({
                ...
                success: function (searchResults) {
                    ...
                    $.each(searchResults, function (index, result) {
                        ...
                        <td class="text-center">${result.km}</td>
             ...
             ${result.isActive ? "Kích hoạt" : "Tạm khóa"}
                        ...
                        <td class="text-center">
                            <a class="px-2" href="/khuyenmai/xoa?makm=${result.url}&isActive=${result.isActive}">
                                <i class="fa ${result.isActive ? "text-danger" : "text-success"} ${result.isActive ? "fa-trash" : "fa-recycle"} " aria-hidden="true"></i>
                            </a >
            <a class="px-2" href="/khuyenmai/cap-nhat?makm=${result.url}&isUpdate=False" >
